...
class GraphModule(torch.nn.Module):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_ids_: "i64[1]", l_self_modules_embed_tokens_parameters_weight_: "bf16[32320, 7168]"):
            ...
            zeros: "f32[122]" = torch.zeros((122,), dtype = torch.float32, device = device(type='cuda', index=3))
            ...
            ge: "b8[1]" = l_input_ids_ >= 96960
            lt: "b8[1]" = l_input_ids_ < 129280
            ...
            mul: "i64[1]" = 96960 * org_vocab_mask
