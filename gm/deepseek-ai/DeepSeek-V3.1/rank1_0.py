...
class GraphModule(torch.nn.Module):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_ids_: "i64[1]", l_self_modules_embed_tokens_parameters_weight_: "bf16[32320, 7168]"):
            ...
            zeros: "f32[122]" = torch.zeros((122,), dtype = torch.float32, device = device(type='cuda', index=1))
            ...
            ge: "b8[1]" = l_input_ids_ >= 32320
            lt: "b8[1]" = l_input_ids_ < 64640
            ...
            mul: "i64[1]" = 32320 * org_vocab_mask
