...
class GraphModule(torch.nn.Module):
    def forward(self, l_hidden_states_: "bf16[1, 7168]", l_residual_: "bf16[1, 7168]", l_self_layer_communicator_input_layernorm_parameters_weight_: "bf16[7168]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 7168]", l_residual_: "bf16[1, 7168]", l_self_layer_communicator_input_layernorm_parameters_weight_: "bf16[7168]"):
            ...
            x: "f32[1, 7168]" = l_hidden_states_.to(torch.float32);  l_hidden_states_ = None
            ...
            mul_1: "f32[1, 7168]" = x_2 * l_self_layer_communicator_input_layernorm_parameters_weight_;  x_2 = l_self_layer_communicator_input_layernorm_parameters_weight_ = None
