...
class GraphModule(torch.nn.Module):
    def forward(self, l_k_: "bf16[1, 1, 512]", l_k_rope_: "bf16[1, 1, 64]", l_forward_batch_token_to_kv_pool_kv_buffer_53_: "bf16[1283878, 1, 576]", l_forward_batch_out_cache_loc: "i64[1]", l_q_rope_: "bf16[1, 32, 64]", l_q_: "bf16[1, 32, 512]"):
        # No stacktrace found for following nodes
        inductor_0 = self.inductor_0(l_forward_batch_token_to_kv_pool_kv_buffer_53_, l_k_, l_k_rope_, l_forward_batch_out_cache_loc);  l_k_ = l_k_rope_ = l_forward_batch_out_cache_loc = inductor_0 = None
        thunder_1 = self.thunder_1(l_q_, l_q_rope_, l_forward_batch_token_to_kv_pool_kv_buffer_53_);  l_q_ = l_q_rope_ = l_forward_batch_token_to_kv_pool_kv_buffer_53_ = None
        getitem = thunder_1[0]
    ...
    class inductor_0(torch.nn.Module):
        def forward(self, l_forward_batch_token_to_kv_pool_kv_buffer_53_: "bf16[1283878, 1, 576]", l_k_: "bf16[1, 1, 512]", l_k_rope_: "bf16[1, 1, 64]", l_forward_batch_out_cache_loc: "i64[1]"):
            ...
            triton_kernel_wrapper_mutation = torch.ops.higher_order.triton_kernel_wrapper_mutation(kernel_idx = 15, constant_args_idx = 156, grid = [(1, 5, 1)], tma_descriptor_metadata = {}, kwargs = {'kv_buffer_ptr': l_forward_batch_token_to_kv_pool_kv_buffer_53_, 'cache_k_nope_ptr': l_k_, 'cache_k_rope_ptr': l_k_rope_, 'loc_ptr': l_forward_batch_out_cache_loc});  l_forward_batch_token_to_kv_pool_kv_buffer_53_ = l_k_ = l_k_rope_ = l_forward_batch_out_cache_loc = triton_kernel_wrapper_mutation = None
            return ()
    ...
    class thunder_1(torch.nn.Module):
        def forward(self, l_q_: "bf16[1, 32, 512]", l_q_rope_: "bf16[1, 32, 64]", l_forward_batch_token_to_kv_pool_kv_buffer_53_: "bf16[1283878, 1, 576]"):
            ...
            k_buffer: "bf16[1283878, 1, 576]" = l_forward_batch_token_to_kv_pool_kv_buffer_53_.to(torch.bfloat16);  l_forward_batch_token_to_kv_pool_kv_buffer_53_ = None
