...
class GraphModule(torch.nn.Module):
    def forward(self, l_args_0_: "bf16[1, 512]", l_self_parameters_weight_: "bf16[512]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_args_0_: "bf16[1, 512]", l_self_parameters_weight_: "bf16[512]"):
            ...
            x: "f32[1, 512]" = l_args_0_.to(torch.float32);  l_args_0_ = None
            ...
            x_1: "f32[1, 512]" = x * rsqrt;  x = rsqrt = None
            ...
            mul_1: "f32[1, 512]" = x_1 * l_self_parameters_weight_;  x_1 = l_self_parameters_weight_ = None
            x_2: "bf16[1, 512]" = mul_1.to(torch.bfloat16);  mul_1 = None
            return x_2
