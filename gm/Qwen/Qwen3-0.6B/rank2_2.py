...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_parameters_weight_: "bf16[1024, 1024]", l_input_: "bf16[1, 1024]"):
        # No stacktrace found for following nodes
        thunder_0 = self.thunder_0(l_input_, l_self_parameters_weight_);  l_input_ = l_self_parameters_weight_ = None
        return (thunder_0,)
        
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "bf16[1, 1024]", l_self_parameters_weight_: "bf16[1024, 1024]"):
