...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[37984, 1024]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[37984, 1024]"):
            ...
            ge: "b8[1]" = l_input_ >= 113952
            lt: "b8[1]" = l_input_ < 151936
            ...
            output_parallel: "bf16[1, 1024]" = torch.nn.functional.embedding(long, l_self_parameters_weight_);  long = l_self_parameters_weight_ = None
            ...
            masked_fill_: "bf16[1, 1024]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "bf16[1, 1024]"):
