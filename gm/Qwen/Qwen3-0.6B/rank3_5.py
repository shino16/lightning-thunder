...
class GraphModule(torch.nn.Module):
    def forward(self, l_args_0_: "i64[1]", l_self_buffers_cos_sin_cache_: "f32[40960, 128]", l_args_1_: "bf16[1, 512]", l_args_2_: "bf16[1, 256]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_args_0_: "i64[1]", l_self_buffers_cos_sin_cache_: "f32[40960, 128]", l_args_1_: "bf16[1, 512]", l_args_2_: "bf16[1, 256]"):
            ...
            query: "bf16[1, 4, 128]" = l_args_1_.view(1, -1, 128);  l_args_1_ = None
            ...
            query_rot: "bf16[1, 4, 128]" = query[(Ellipsis, slice(None, 128, None))]
            ...
            query_pass: "bf16[1, 4, 0]" = query[(Ellipsis, slice(128, None, None))];  query = None
            ...
            x1: "bf16[1, 4, 64]" = chunk_1[0]
            x2: "bf16[1, 4, 64]" = chunk_1[1];  chunk_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/rotary_embedding.py:71 in _apply_rotary_emb, code: o1 = x1 * cos - x2 * sin
            mul: "bf16[1, 4, 64]" = x1 * cos_1
            mul_1: "bf16[1, 4, 64]" = x2 * sin_1
            o1: "bf16[1, 4, 64]" = mul - mul_1;  mul = mul_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/rotary_embedding.py:72 in _apply_rotary_emb, code: o2 = x2 * cos + x1 * sin
            mul_2: "bf16[1, 4, 64]" = x2 * cos_1;  x2 = cos_1 = None
            mul_3: "bf16[1, 4, 64]" = x1 * sin_1;  x1 = sin_1 = None
            o2: "bf16[1, 4, 64]" = mul_2 + mul_3;  mul_2 = mul_3 = None
            ...
            query_rot_1: "bf16[1, 4, 128]" = torch.cat((o1, o2), dim = -1);  o1 = o2 = None
            ...
            cat_1: "bf16[1, 4, 128]" = torch.cat((query_rot_1, query_pass), dim = -1);  query_rot_1 = query_pass = None
            query_1: "bf16[1, 512]" = cat_1.reshape((1, 512));  cat_1 = None
            ...
            key: "bf16[1, 2, 128]" = l_args_2_.view(1, -1, 128);  l_args_2_ = None
