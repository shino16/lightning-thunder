...
class GraphModule(torch.nn.Module):
    def forward(self, l_forward_batch_next_token_logits_buffer: "f32[1, 151936]", l_self_modules_lm_head_parameters_weight_: "bf16[37984, 1024]", l_stack0_: "bf16[1, 1024]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "bf16[1, 1024]", l_self_modules_lm_head_parameters_weight_: "bf16[37984, 1024]"):
            ...
            to: "bf16[1, 1024]" = l_stack0_.to(torch.bfloat16);  l_stack0_ = None
            getattr_1: "bf16[1024, 37984]" = l_self_modules_lm_head_parameters_weight_.T;  l_self_modules_lm_head_parameters_weight_ = None
