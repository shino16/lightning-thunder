...
class GraphModule(torch.nn.Module):
    def forward(self, l_args_0_: "bf16[4, 128]", l_self_parameters_weight_: "bf16[128]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_args_0_: "bf16[4, 128]", l_self_parameters_weight_: "bf16[128]"):
            ...
            x: "f32[4, 128]" = l_args_0_.to(torch.float32);  l_args_0_ = None
            ...
            pow_1: "f32[4, 128]" = x.pow(2)
            variance: "f32[4, 1]" = pow_1.mean(dim = -1, keepdim = True);  pow_1 = None
            ...
            add: "f32[4, 1]" = variance + 1e-06;  variance = None
            rsqrt: "f32[4, 1]" = torch.rsqrt(add);  add = None
            x_1: "f32[4, 128]" = x * rsqrt;  x = rsqrt = None
            ...
            mul_1: "f32[4, 128]" = x_1 * l_self_parameters_weight_;  x_1 = l_self_parameters_weight_ = None
            x_2: "bf16[4, 128]" = mul_1.to(torch.bfloat16);  mul_1 = None
            return x_2
