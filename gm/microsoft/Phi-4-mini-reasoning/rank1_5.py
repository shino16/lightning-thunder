...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_modules_o_proj_parameters_weight_: "bf16[3072, 768]", l_stack0_: "bf16[1, 768]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "bf16[1, 768]", l_self_modules_o_proj_parameters_weight_: "bf16[3072, 768]"):
            ...
            output_parallel: "bf16[1, 3072]" = torch._C._nn.linear(l_stack0_, l_self_modules_o_proj_parameters_weight_, None);  l_stack0_ = l_self_modules_o_proj_parameters_weight_ = None
