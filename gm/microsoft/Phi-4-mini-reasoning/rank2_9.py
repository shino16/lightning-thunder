...
class GraphModule(torch.nn.Module):
    def forward(self, l_args_0_: "bf16[1, 3072]", l_args_1_: "bf16[1, 3072]", l_self_parameters_weight_: "bf16[3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_args_0_: "bf16[1, 3072]", l_args_1_: "bf16[1, 3072]", l_self_parameters_weight_: "bf16[3072]"):
            ...
            x: "f32[1, 3072]" = l_args_0_.to(torch.float32);  l_args_0_ = None
            ...
            to_1: "f32[1, 3072]" = l_args_1_.to(torch.float32);  l_args_1_ = None
            ...
            mul_1: "f32[1, 3072]" = x_2 * l_self_parameters_weight_;  x_2 = l_self_parameters_weight_ = None
