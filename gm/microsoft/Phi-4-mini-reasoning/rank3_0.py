...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[50016, 3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[50016, 3072]"):
            ...
            ge: "b8[1]" = l_input_ >= 150048
            lt: "b8[1]" = l_input_ < 200064
            ...
            mul: "i64[1]" = 150048 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 150048 * added_vocab_mask
            ...
            output_parallel: "bf16[1, 3072]" = torch.nn.functional.embedding(long, l_self_parameters_weight_);  long = l_self_parameters_weight_ = None
            ...
            masked_fill_: "bf16[1, 3072]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "bf16[1, 3072]"):
