...
class GraphModule(torch.nn.Module):
    def forward(self, l_hidden_states_: "bf16[1, 3072]", l_self_modules_input_layernorm_parameters_weight_: "bf16[3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 3072]", l_self_modules_input_layernorm_parameters_weight_: "bf16[3072]"):
            ...
            x_1: "f32[1, 3072]" = x * rsqrt;  x = rsqrt = None
            ...
            mul_1: "f32[1, 3072]" = x_1 * l_self_modules_input_layernorm_parameters_weight_;  x_1 = l_self_modules_input_layernorm_parameters_weight_ = None
            x_2: "bf16[1, 3072]" = mul_1.to(torch.bfloat16);  mul_1 = None
            return x_2
