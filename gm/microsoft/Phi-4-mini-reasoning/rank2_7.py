...
class GraphModule(torch.nn.Module):
    def forward(self, l_residual_: "bf16[1, 3072]", l_hidden_states_: "bf16[1, 3072]", l_self_modules_input_layernorm_parameters_weight_: "bf16[3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 3072]", l_residual_: "bf16[1, 3072]", l_self_modules_input_layernorm_parameters_weight_: "bf16[3072]"):
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/layernorm.py:167 in forward_native, code: x = x.to(torch.float32)
            x: "f32[1, 3072]" = l_hidden_states_.to(torch.float32);  l_hidden_states_ = None
            ...
            mul_1: "f32[1, 3072]" = x_2 * l_self_modules_input_layernorm_parameters_weight_;  x_2 = l_self_modules_input_layernorm_parameters_weight_ = None
