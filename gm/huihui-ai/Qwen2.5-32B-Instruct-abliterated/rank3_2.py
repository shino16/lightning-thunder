...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_modules_qkv_proj_parameters_bias_: "bf16[1792]", l_self_modules_qkv_proj_parameters_weight_: "bf16[1792, 5120]", l_hidden_states_: "bf16[1, 5120]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[32768, 128]"):
        # No stacktrace found for following nodes
        thunder_0 = self.thunder_0(l_hidden_states_, l_self_modules_qkv_proj_parameters_weight_, l_self_modules_qkv_proj_parameters_bias_, l_positions_, l_self_modules_rotary_emb_buffers_cos_sin_cache_);  l_hidden_states_ = l_self_modules_qkv_proj_parameters_weight_ = l_self_modules_qkv_proj_parameters_bias_ = l_positions_ = l_self_modules_rotary_emb_buffers_cos_sin_cache_ = None
        getitem = thunder_0[0]
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 5120]", l_self_modules_qkv_proj_parameters_weight_: "bf16[1792, 5120]", l_self_modules_qkv_proj_parameters_bias_: "bf16[1792]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[32768, 128]"):
            ...
            output_parallel: "bf16[1, 1792]" = torch._C._nn.linear(l_hidden_states_, l_self_modules_qkv_proj_parameters_weight_, l_self_modules_qkv_proj_parameters_bias_);  l_hidden_states_ = l_self_modules_qkv_proj_parameters_weight_ = l_self_modules_qkv_proj_parameters_bias_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/models/qwen2.py:181 in forward, code: q, k, v = qkv.split([self.q_size, self.kv_size, self.kv_size], dim=-1)
            split = output_parallel.split([1280, 256, 256], dim = -1);  output_parallel = None
            q: "bf16[1, 1280]" = split[0]
            ...
            query: "bf16[1, 10, 128]" = q.view(1, -1, 128);  q = None
            ...
            query_1: "bf16[1, 1280]" = cat_1.reshape((1, 1280));  cat_1 = None
            ...
            key_1: "bf16[1, 256]" = cat_3.reshape((1, 256));  cat_3 = None
