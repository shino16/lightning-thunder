...
class GraphModule(torch.nn.Module):
    def forward(self, l_hidden_states_: "bf16[1, 5120]", l_self_modules_input_layernorm_parameters_weight_: "bf16[5120]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 5120]", l_self_modules_input_layernorm_parameters_weight_: "bf16[5120]"):
            ...
            mul_1: "f32[1, 5120]" = x_1 * l_self_modules_input_layernorm_parameters_weight_;  x_1 = l_self_modules_input_layernorm_parameters_weight_ = None
