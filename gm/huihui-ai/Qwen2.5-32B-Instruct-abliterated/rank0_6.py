...
class GraphModule(torch.nn.Module):
    def forward(self, l_stack0_: "bf16[1, 5120]", l_residual_: "bf16[1, 5120]", l_self_modules_post_attention_layernorm_parameters_weight_: "bf16[5120]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "bf16[13824, 5120]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "bf16[5120, 6912]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "bf16[1, 5120]", l_residual_: "bf16[1, 5120]", l_self_modules_post_attention_layernorm_parameters_weight_: "bf16[5120]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "bf16[13824, 5120]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "bf16[5120, 6912]"):
            ...
            x: "f32[1, 5120]" = l_stack0_.to(torch.float32);  l_stack0_ = None
            ...
            to_1: "f32[1, 5120]" = l_residual_.to(torch.float32);  l_residual_ = None
            ...
            residual: "bf16[1, 5120]" = x_1.to(torch.bfloat16)
            ...
            mul_1: "f32[1, 5120]" = x_2 * l_self_modules_post_attention_layernorm_parameters_weight_;  x_2 = l_self_modules_post_attention_layernorm_parameters_weight_ = None
            x_3: "bf16[1, 5120]" = mul_1.to(torch.bfloat16);  mul_1 = None
            ...
            output_parallel: "bf16[1, 13824]" = torch._C._nn.linear(x_3, l_self_modules_mlp_modules_gate_up_proj_parameters_weight_, None);  x_3 = l_self_modules_mlp_modules_gate_up_proj_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/activation.py:64 in forward_native, code: return F.silu(x[..., :d]) * x[..., d:]
            getitem: "bf16[1, 6912]" = output_parallel[(Ellipsis, slice(None, 6912, None))]
            silu: "bf16[1, 6912]" = torch.nn.functional.silu(getitem);  getitem = None
            getitem_1: "bf16[1, 6912]" = output_parallel[(Ellipsis, slice(6912, None, None))];  output_parallel = None
            x_4: "bf16[1, 6912]" = silu * getitem_1;  silu = getitem_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/quantization/unquant.py:133 in apply, code: return F.linear(x, layer.weight, bias)
            output_parallel_1: "bf16[1, 5120]" = torch._C._nn.linear(x_4, l_self_modules_mlp_modules_down_proj_parameters_weight_, None);  x_4 = l_self_modules_mlp_modules_down_proj_parameters_weight_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel_1: "bf16[1, 5120]"):
