...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[38016, 5120]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[38016, 5120]"):
            ...
            ge: "b8[1]" = l_input_ >= 114048
            lt: "b8[1]" = l_input_ < 152064
            ...
            mul: "i64[1]" = 114048 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 114048 * added_vocab_mask
            ...
            output_parallel: "bf16[1, 5120]" = torch.nn.functional.embedding(long, l_self_parameters_weight_);  long = l_self_parameters_weight_ = None
