...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_ids_: "i64[1]", l_language_model_modules_model_modules_embed_tokens_parameters_weight_: "bf16[50512, 5120]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_ids_: "i64[1]", l_language_model_modules_model_modules_embed_tokens_parameters_weight_: "bf16[50512, 5120]"):
            ...
            ge: "b8[1]" = l_input_ids_ >= 151536
            lt: "b8[1]" = l_input_ids_ < 202048
            ...
            mul: "i64[1]" = 151536 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 151536 * added_vocab_mask
            ...
            output_parallel: "bf16[1, 5120]" = torch.nn.functional.embedding(long, l_language_model_modules_model_modules_embed_tokens_parameters_weight_);  long = l_language_model_modules_model_modules_embed_tokens_parameters_weight_ = None
            ...
            masked_fill_: "bf16[1, 5120]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "bf16[1, 5120]"):
