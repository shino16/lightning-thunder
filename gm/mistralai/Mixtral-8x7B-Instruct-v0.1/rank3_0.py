...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[8000, 4096]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[8000, 4096]"):
            ...
            ge: "b8[1]" = l_input_ >= 24000
            lt: "b8[1]" = l_input_ < 32000
            ...
            mul: "i64[1]" = 24000 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 24000 * added_vocab_mask
            ...
            output_parallel: "bf16[1, 4096]" = torch.nn.functional.embedding(long, l_self_parameters_weight_);  long = l_self_parameters_weight_ = None
            ...
            masked_fill_: "bf16[1, 4096]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "bf16[1, 4096]"):
