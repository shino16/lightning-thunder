...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_modules_qkv_proj_parameters_weight_: "bf16[1536, 4096]", l_hidden_states_: "bf16[1, 4096]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[32768, 128]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 4096]", l_self_modules_qkv_proj_parameters_weight_: "bf16[1536, 4096]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[32768, 128]"):
            ...
            output_parallel: "bf16[1, 1536]" = torch._C._nn.linear(l_hidden_states_, l_self_modules_qkv_proj_parameters_weight_, None);  l_hidden_states_ = l_self_modules_qkv_proj_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/models/mixtral.py:196 in forward, code: q, k, v = qkv.split([self.q_size, self.kv_size, self.kv_size], dim=-1)
            split = output_parallel.split([1024, 256, 256], dim = -1);  output_parallel = None
            q: "bf16[1, 1024]" = split[0]
            ...
            query: "bf16[1, 8, 128]" = q.view(1, -1, 128);  q = None
