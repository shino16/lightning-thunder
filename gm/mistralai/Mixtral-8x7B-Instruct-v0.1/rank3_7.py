...
class GraphModule(torch.nn.Module):
    def forward(self, l_residual_: "bf16[1, 4096]", l_hidden_states_: "bf16[1, 4096]", l_self_modules_input_layernorm_parameters_weight_: "bf16[4096]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "bf16[1, 4096]", l_residual_: "bf16[1, 4096]", l_self_modules_input_layernorm_parameters_weight_: "bf16[4096]"):
            ...
            mul_1: "f32[1, 4096]" = x_2 * l_self_modules_input_layernorm_parameters_weight_;  x_2 = l_self_modules_input_layernorm_parameters_weight_ = None
