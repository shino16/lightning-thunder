...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[32768, 4096]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "bf16[32768, 4096]"):
            ...
            ge: "b8[1]" = l_input_ >= 98304
            lt: "b8[1]" = l_input_ < 131072
            ...
            mul: "i64[1]" = 98304 * org_vocab_mask
