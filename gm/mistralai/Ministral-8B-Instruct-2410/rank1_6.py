...
class GraphModule(torch.nn.Module):
    def forward(self, l_stack0_: "bf16[1, 4096]", l_residual_: "bf16[1, 4096]", l_self_modules_post_attention_layernorm_parameters_weight_: "bf16[4096]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "bf16[6144, 4096]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "bf16[4096, 3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "bf16[1, 4096]", l_residual_: "bf16[1, 4096]", l_self_modules_post_attention_layernorm_parameters_weight_: "bf16[4096]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "bf16[6144, 4096]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "bf16[4096, 3072]"):
            ...
            output_parallel: "bf16[1, 6144]" = torch._C._nn.linear(x_3, l_self_modules_mlp_modules_gate_up_proj_parameters_weight_, None);  x_3 = l_self_modules_mlp_modules_gate_up_proj_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/activation.py:64 in forward_native, code: return F.silu(x[..., :d]) * x[..., d:]
            getitem: "bf16[1, 3072]" = output_parallel[(Ellipsis, slice(None, 3072, None))]
            silu: "bf16[1, 3072]" = torch.nn.functional.silu(getitem);  getitem = None
            getitem_1: "bf16[1, 3072]" = output_parallel[(Ellipsis, slice(3072, None, None))];  output_parallel = None
            x_4: "bf16[1, 3072]" = silu * getitem_1;  silu = getitem_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/quantization/unquant.py:133 in apply, code: return F.linear(x, layer.weight, bias)
            output_parallel_1: "bf16[1, 4096]" = torch._C._nn.linear(x_4, l_self_modules_mlp_modules_down_proj_parameters_weight_, None);  x_4 = l_self_modules_mlp_modules_down_proj_parameters_weight_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel_1: "bf16[1, 4096]"):
