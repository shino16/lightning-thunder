...
class GraphModule(torch.nn.Module):
    def forward(self, l_hidden_states_: "f16[1, 12288]", l_self_modules_input_layernorm_parameters_weight_: "f16[12288]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "f16[1, 12288]", l_self_modules_input_layernorm_parameters_weight_: "f16[12288]"):
            ...
            x_1: "f32[1, 12288]" = x * rsqrt;  x = rsqrt = None
            ...
            mul_1: "f32[1, 12288]" = x_1 * l_self_modules_input_layernorm_parameters_weight_;  x_1 = l_self_modules_input_layernorm_parameters_weight_ = None
            x_2: "f16[1, 12288]" = mul_1.to(torch.float16);  mul_1 = None
            return x_2
