...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_modules_o_proj_parameters_weight_: "f16[12288, 3072]", l_stack0_: "f16[1, 3072]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "f16[1, 3072]", l_self_modules_o_proj_parameters_weight_: "f16[12288, 3072]"):
            ...
            output_parallel: "f16[1, 12288]" = torch._C._nn.linear(l_stack0_, l_self_modules_o_proj_parameters_weight_, None);  l_stack0_ = l_self_modules_o_proj_parameters_weight_ = None
