...
class GraphModule(torch.nn.Module):
    def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "f16[8192, 12288]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_: "i64[1]", l_self_parameters_weight_: "f16[8192, 12288]"):
            ...
            ge: "b8[1]" = l_input_ >= 24576
            lt: "b8[1]" = l_input_ < 32768
            ...
            mul: "i64[1]" = 24576 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 24576 * added_vocab_mask
            ...
            output_parallel: "f16[1, 12288]" = torch.nn.functional.embedding(long, l_self_parameters_weight_);  long = l_self_parameters_weight_ = None
            ...
            masked_fill_: "f16[1, 12288]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "f16[1, 12288]"):
