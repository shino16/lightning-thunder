...
class GraphModule(torch.nn.Module):
    def forward(self, l_residual_: "f16[1, 12288]", l_hidden_states_: "f16[1, 12288]", l_self_modules_input_layernorm_parameters_weight_: "f16[12288]"):
        # No stacktrace found for following nodes
        thunder_0 = self.thunder_0(l_hidden_states_, l_residual_, l_self_modules_input_layernorm_parameters_weight_);  l_hidden_states_ = l_residual_ = l_self_modules_input_layernorm_parameters_weight_ = None
        getitem = thunder_0[0]
        getitem_1 = thunder_0[1];  thunder_0 = None
        return (getitem, getitem_1)
        
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "f16[1, 12288]", l_residual_: "f16[1, 12288]", l_self_modules_input_layernorm_parameters_weight_: "f16[12288]"):
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/layernorm.py:167 in forward_native, code: x = x.to(torch.float32)
            x: "f32[1, 12288]" = l_hidden_states_.to(torch.float32);  l_hidden_states_ = None
            ...
            mul_1: "f32[1, 12288]" = x_2 * l_self_modules_input_layernorm_parameters_weight_;  x_2 = l_self_modules_input_layernorm_parameters_weight_ = None
