...
class GraphModule(torch.nn.Module):
    def forward(self, l_stack0_: "f16[1, 12288]", l_residual_: "f16[1, 12288]", l_self_modules_post_attention_layernorm_parameters_weight_: "f16[12288]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "f16[14336, 12288]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "f16[12288, 7168]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "f16[1, 12288]", l_residual_: "f16[1, 12288]", l_self_modules_post_attention_layernorm_parameters_weight_: "f16[12288]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "f16[14336, 12288]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "f16[12288, 7168]"):
            ...
            x: "f32[1, 12288]" = l_stack0_.to(torch.float32);  l_stack0_ = None
            ...
            to_1: "f32[1, 12288]" = l_residual_.to(torch.float32);  l_residual_ = None
            x_1: "f32[1, 12288]" = x + to_1;  x = to_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/layernorm.py:170 in forward_native, code: residual = x.to(orig_dtype)
            residual: "f16[1, 12288]" = x_1.to(torch.float16)
            ...
            x_2: "f32[1, 12288]" = x_1 * rsqrt;  x_1 = rsqrt = None
            ...
            mul_1: "f32[1, 12288]" = x_2 * l_self_modules_post_attention_layernorm_parameters_weight_;  x_2 = l_self_modules_post_attention_layernorm_parameters_weight_ = None
            x_3: "f16[1, 12288]" = mul_1.to(torch.float16);  mul_1 = None
            ...
            output_parallel: "f16[1, 14336]" = torch._C._nn.linear(x_3, l_self_modules_mlp_modules_gate_up_proj_parameters_weight_, None);  x_3 = l_self_modules_mlp_modules_gate_up_proj_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/activation.py:64 in forward_native, code: return F.silu(x[..., :d]) * x[..., d:]
            getitem: "f16[1, 7168]" = output_parallel[(Ellipsis, slice(None, 7168, None))]
            silu: "f16[1, 7168]" = torch.nn.functional.silu(getitem);  getitem = None
            getitem_1: "f16[1, 7168]" = output_parallel[(Ellipsis, slice(7168, None, None))];  output_parallel = None
            x_4: "f16[1, 7168]" = silu * getitem_1;  silu = getitem_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/quantization/unquant.py:133 in apply, code: return F.linear(x, layer.weight, bias)
            output_parallel_1: "f16[1, 12288]" = torch._C._nn.linear(x_4, l_self_modules_mlp_modules_down_proj_parameters_weight_, None);  x_4 = l_self_modules_mlp_modules_down_proj_parameters_weight_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel_1: "f16[1, 12288]"):
