...
class GraphModule(torch.nn.Module):
    def forward(self, l_hidden_states_: "f16[1, 5120]", l_self_modules_input_layernorm_parameters_weight_: "f16[5120]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "f16[1, 5120]", l_self_modules_input_layernorm_parameters_weight_: "f16[5120]"):
            ...
            x_2: "f16[1, 5120]" = mul_1.to(torch.float16);  mul_1 = None
            return x_2
