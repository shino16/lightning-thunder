...
class GraphModule(torch.nn.Module):
    def forward(self, l_stack0_: "f16[1, 5120]", l_residual_: "f16[1, 5120]", l_self_modules_post_attention_layernorm_parameters_weight_: "f16[5120]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "f16[16384, 5120]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "f16[5120, 8192]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "f16[1, 5120]", l_residual_: "f16[1, 5120]", l_self_modules_post_attention_layernorm_parameters_weight_: "f16[5120]", l_self_modules_mlp_modules_gate_up_proj_parameters_weight_: "f16[16384, 5120]", l_self_modules_mlp_modules_down_proj_parameters_weight_: "f16[5120, 8192]"):
            ...
            output_parallel: "f16[1, 16384]" = torch._C._nn.linear(x_3, l_self_modules_mlp_modules_gate_up_proj_parameters_weight_, None);  x_3 = l_self_modules_mlp_modules_gate_up_proj_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/activation.py:64 in forward_native, code: return F.silu(x[..., :d]) * x[..., d:]
            getitem: "f16[1, 8192]" = output_parallel[(Ellipsis, slice(None, 8192, None))]
            silu: "f16[1, 8192]" = torch.nn.functional.silu(getitem);  getitem = None
            getitem_1: "f16[1, 8192]" = output_parallel[(Ellipsis, slice(8192, None, None))];  output_parallel = None
            x_4: "f16[1, 8192]" = silu * getitem_1;  silu = getitem_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/quantization/unquant.py:133 in apply, code: return F.linear(x, layer.weight, bias)
            output_parallel_1: "f16[1, 5120]" = torch._C._nn.linear(x_4, l_self_modules_mlp_modules_down_proj_parameters_weight_, None);  x_4 = l_self_modules_mlp_modules_down_proj_parameters_weight_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel_1: "f16[1, 5120]"):
