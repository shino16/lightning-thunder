...
class GraphModule(torch.nn.Module):
    def forward(self, l_forward_batch_next_token_logits_buffer: "f32[1, 131072]", l_self_modules_lm_head_parameters_weight_: "f16[32768, 5120]", l_stack0_: "f16[1, 5120]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_stack0_: "f16[1, 5120]", l_self_modules_lm_head_parameters_weight_: "f16[32768, 5120]"):
            ...
            to: "f16[1, 5120]" = l_stack0_.to(torch.float16);  l_stack0_ = None
            getattr_1: "f16[5120, 32768]" = l_self_modules_lm_head_parameters_weight_.T;  l_self_modules_lm_head_parameters_weight_ = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/logits_processor.py:472 in _get_logits, code: logits = torch.matmul(
            logits: "f16[1, 32768]" = torch.matmul(to, getattr_1);  to = getattr_1 = None
            ...
            output_tensor: "f16[4, 32768]" = torch.empty((4, 32768), dtype = torch.float16, device = device(type='cuda', index=1))
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, logits: "f16[1, 32768]", output_tensor: "f16[4, 32768]"):
    ...
    class thunder_2(torch.nn.Module):
        def forward(self, output_tensor: "f16[4, 32768]", l_forward_batch_next_token_logits_buffer: "f32[1, 131072]"):
            ...
            output_tensor_1: "f16[4, 1, 32768]" = output_tensor.reshape((4, 1, 32768));  output_tensor = None
            ...
            output_tensor_2: "f16[1, 4, 32768]" = output_tensor_1.movedim(0, 1);  output_tensor_1 = None
            ...
            output_tensor_3: "f16[1, 131072]" = output_tensor_2.reshape((1, 131072));  output_tensor_2 = None
            ...
            getitem: "f16[1, 131072]" = output_tensor_3[(slice(None, None, None), slice(None, 131072, None))];  output_tensor_3 = None
