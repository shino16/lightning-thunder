...
class GraphModule(torch.nn.Module):
    def forward(self, l_self_modules_qkv_proj_parameters_weight_: "f16[1536, 5120]", l_hidden_states_: "f16[1, 5120]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[131072, 128]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_hidden_states_: "f16[1, 5120]", l_self_modules_qkv_proj_parameters_weight_: "f16[1536, 5120]", l_positions_: "i64[1]", l_self_modules_rotary_emb_buffers_cos_sin_cache_: "f32[131072, 128]"):
            ...
            output_parallel: "f16[1, 1536]" = torch._C._nn.linear(l_hidden_states_, l_self_modules_qkv_proj_parameters_weight_, None);  l_hidden_states_ = l_self_modules_qkv_proj_parameters_weight_ = None
            ...
            split = output_parallel.split([1024, 256, 256], dim = -1);  output_parallel = None
            q: "f16[1, 1024]" = split[0]
            k: "f16[1, 256]" = split[1]
            ...
            query: "f16[1, 8, 128]" = q.view(1, -1, 128);  q = None
            ...
            query_rot: "f16[1, 8, 128]" = query[(Ellipsis, slice(None, 128, None))]
            ...
            query_pass: "f16[1, 8, 0]" = query[(Ellipsis, slice(128, None, None))];  query = None
            ...
            x1: "f16[1, 8, 64]" = chunk_1[0]
            x2: "f16[1, 8, 64]" = chunk_1[1];  chunk_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/rotary_embedding.py:71 in _apply_rotary_emb, code: o1 = x1 * cos - x2 * sin
            mul: "f16[1, 8, 64]" = x1 * cos_1
            mul_1: "f16[1, 8, 64]" = x2 * sin_1
            o1: "f16[1, 8, 64]" = mul - mul_1;  mul = mul_1 = None
            
             # File: /opt/sglang/sglang-src/python/sglang/srt/layers/rotary_embedding.py:72 in _apply_rotary_emb, code: o2 = x2 * cos + x1 * sin
            mul_2: "f16[1, 8, 64]" = x2 * cos_1;  x2 = cos_1 = None
            mul_3: "f16[1, 8, 64]" = x1 * sin_1;  x1 = sin_1 = None
            o2: "f16[1, 8, 64]" = mul_2 + mul_3;  mul_2 = mul_3 = None
            ...
            query_rot_1: "f16[1, 8, 128]" = torch.cat((o1, o2), dim = -1);  o1 = o2 = None
            ...
            cat_1: "f16[1, 8, 128]" = torch.cat((query_rot_1, query_pass), dim = -1);  query_rot_1 = query_pass = None
            query_1: "f16[1, 1024]" = cat_1.reshape((1, 1024));  cat_1 = None
