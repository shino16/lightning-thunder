...
class GraphModule(torch.nn.Module):
    def forward(self, l_forward_batch_token_to_kv_pool_k_buffer_0_: "bf16[12755584, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_0_: "bf16[12755584, 2, 64]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_forward_batch_token_to_kv_pool_k_buffer_0_: "bf16[12755584, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_0_: "bf16[12755584, 2, 64]"):
            ...
            view: "bf16[12755584, 128]" = l_forward_batch_token_to_kv_pool_k_buffer_0_.view(12755584, -1);  l_forward_batch_token_to_kv_pool_k_buffer_0_ = None
            ...
            view_1: "bf16[12755584, 128]" = l_forward_batch_token_to_kv_pool_v_buffer_0_.view(12755584, -1);  l_forward_batch_token_to_kv_pool_v_buffer_0_ = None
            return (view_1, view)
