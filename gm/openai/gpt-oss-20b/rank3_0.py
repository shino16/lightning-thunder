...
class GraphModule(torch.nn.Module):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_input_ids_: "i64[1]", l_self_modules_embed_tokens_parameters_weight_: "bf16[50272, 2880]"):
            ...
            ge: "b8[1]" = l_input_ids_ >= 150816
            lt: "b8[1]" = l_input_ids_ < 201088
            ...
            mul: "i64[1]" = 150816 * org_vocab_mask
            ...
            mul_1: "i64[1]" = 150816 * added_vocab_mask
            ...
            masked_fill_: "bf16[1, 2880]" = output_parallel.masked_fill_(unsqueeze, 0);  unsqueeze = masked_fill_ = None
    ...
    class inductor_1(torch.nn.Module):
        def forward(self, output_parallel: "bf16[1, 2880]"):
