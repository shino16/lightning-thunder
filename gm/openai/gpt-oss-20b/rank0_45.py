...
class GraphModule(torch.nn.Module):
    def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_11_: "bf16[20842304, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_11_: "bf16[20842304, 2, 64]"):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_11_: "bf16[20842304, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_11_: "bf16[20842304, 2, 64]"):
            ...
            view_1: "bf16[325661, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_k_buffer_11_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_k_buffer_11_ = None
            ...
            view_2: "bf16[325661, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_v_buffer_11_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_v_buffer_11_ = None
