...
class GraphModule(torch.nn.Module):
    def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_15_: "bf16[20312896, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_15_: "bf16[20312896, 2, 64]"):
        # No stacktrace found for following nodes
        thunder_0 = self.thunder_0(l_q_, l_forward_batch_token_to_kv_pool_k_buffer_15_, l_forward_batch_token_to_kv_pool_v_buffer_15_);  l_q_ = l_forward_batch_token_to_kv_pool_k_buffer_15_ = l_forward_batch_token_to_kv_pool_v_buffer_15_ = None
        getitem = thunder_0[0]
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_15_: "bf16[20312896, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_15_: "bf16[20312896, 2, 64]"):
            ...
            view_1: "bf16[317389, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_k_buffer_15_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_k_buffer_15_ = None
            ...
            view_2: "bf16[317389, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_v_buffer_15_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_v_buffer_15_ = None
