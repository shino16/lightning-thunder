...
class GraphModule(torch.nn.Module):
    ...
    class thunder_0(torch.nn.Module):
        def forward(self):
            ...
            output: "bf16[1, 1, 2880]" = torch.empty((1, 1, 2880), device = device(type='cuda', index=1), dtype = torch.bfloat16)
            ...
            empty_1: "f32[3, 1, 4, 2880]" = torch.empty((3, 1, 4, 2880), device = device(type='cuda', index=1), dtype = torch.float32)
