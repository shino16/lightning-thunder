...
class GraphModule(torch.nn.Module):
    def forward(self, l_stack0_: "bf16[1, 2880]", l_residual_: "bf16[1, 2880]", l_self_layer_communicator_post_attention_layernorm_parameters_weight_: "bf16[2880]"):
        # No stacktrace found for following nodes
        inductor_0 = self.inductor_0(l_stack0_, l_residual_, l_self_layer_communicator_post_attention_layernorm_parameters_weight_);  l_stack0_ = l_residual_ = l_self_layer_communicator_post_attention_layernorm_parameters_weight_ = None
    ...
    class inductor_0(torch.nn.Module):
        def forward(self, l_stack0_: "bf16[1, 2880]", l_residual_: "bf16[1, 2880]", l_self_layer_communicator_post_attention_layernorm_parameters_weight_: "bf16[2880]"):
            ...
            flashinfer_allreduce_residual_rmsnorm = torch.ops.sglang.flashinfer_allreduce_residual_rmsnorm(input_tensor = l_stack0_, residual = l_residual_, weight = l_self_layer_communicator_post_attention_layernorm_parameters_weight_, eps = 1e-05);  l_stack0_ = l_residual_ = l_self_layer_communicator_post_attention_layernorm_parameters_weight_ = None
