...
class GraphModule(torch.nn.Module):
    def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_11_: "bf16[20312896, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_11_: "bf16[20312896, 2, 64]"):
        # No stacktrace found for following nodes
        thunder_0 = self.thunder_0(l_q_, l_forward_batch_token_to_kv_pool_k_buffer_11_, l_forward_batch_token_to_kv_pool_v_buffer_11_);  l_q_ = l_forward_batch_token_to_kv_pool_k_buffer_11_ = l_forward_batch_token_to_kv_pool_v_buffer_11_ = None
        getitem = thunder_0[0]
    ...
    class thunder_0(torch.nn.Module):
        def forward(self, l_q_: "bf16[1, 1024]", l_forward_batch_token_to_kv_pool_k_buffer_11_: "bf16[20312896, 2, 64]", l_forward_batch_token_to_kv_pool_v_buffer_11_: "bf16[20312896, 2, 64]"):
            ...
            view_1: "bf16[317389, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_k_buffer_11_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_k_buffer_11_ = None
            ...
            k_cache: "bf16[317389, 2, 64, 64]" = view_1.permute(0, 2, 1, 3);  view_1 = None
            ...
            view_2: "bf16[317389, 64, 2, 64]" = l_forward_batch_token_to_kv_pool_v_buffer_11_.view(-1, 64, 2, 64);  l_forward_batch_token_to_kv_pool_v_buffer_11_ = None
            ...
            v_cache: "bf16[317389, 2, 64, 64]" = view_2.permute(0, 2, 1, 3);  view_2 = None
