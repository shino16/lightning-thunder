...
@interpreter_needs_wrap
def record_function_enter_lookaside(*args, **kwargs):
    warnings.warn("Currently `torch.autograd.profiler.record_function` is ignored by `thunder.jit`. ")
...
@interpreter_needs_wrap
def record_function_exit_lookaside(*args, **kwargs):
